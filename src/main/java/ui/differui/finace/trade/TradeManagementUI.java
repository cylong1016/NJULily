...
public class TradeManagementUI extends JLabel implements ActionListener{
	...
	MyJButton button_search, button_account, button_showAll
		, button_client, button_add, button_del, button_set, button_finish;
	...
	public TradeManagementUI(){
		...
		String[] comboBoxStr2 = {"请选择交易单种类", "收款单", "付款单", "现金费用单"};
		...
		word_4.setBounds(365 + 260, 385, 40, 25);
		this.add(word_4);
		
		button_set = new MyJButton("设定金额");
		button_set.setBounds(665, 385, 120, 25);
		button_set.addActionListener(this);
		button_set.setBackground(backColor);
		button_set.setForeground(foreColor);
		this.add(button_set);
		...
		jsp3.setBounds(75 + 290, 425, 1125 - 290, 130);
		...
		button_add.setBounds(940, 385, 120, 25);
		...
		button_del.setBounds(1080, 385, 120, 25);
